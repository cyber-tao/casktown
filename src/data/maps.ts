...
function buildMap001(): MapData {
  ...
  map.events = [
    ...
    {
      id: 'NPC_PINEAPPLE_START', x: 11, y: 19, width: 1, height: 1,
      type: 'npc', trigger: 'action', sprite: 'npc_uncle_boluo', direction: 2,
      conditions: [{ flag: 'garden_started', value: false }],
      actions: [
        { type: 'questStart', questId: 'QST_002' },
        { type: 'dialogue', dialogueId: 'DIA_002_GARDEN' },
        { type: 'questAdvance', questId: 'QST_002' },
        { type: 'setFlag', flag: 'garden_started', value: true },
      ],
    },
    {
      id: 'NPC_PINEAPPLE_WAIT', x: 11, y: 19, width: 1, height: 1,
      type: 'npc', trigger: 'action', sprite: 'npc_uncle_boluo', direction: 2,
      conditions: [{ flag: 'garden_started', value: true }, { flag: 'garden_cleaned', value: false }],
      actions: [{ type: 'dialogue', dialogueId: 'DIA_002_GARDEN_WAIT' }],
    },
    {
    ...
    },
    {
      ...
      conditions: [{ flag: 'garden_started', value: true }, { flag: 'garden_cleaned', value: false }],
      actions: [
        { type: 'dialogue', dialogueId: 'DIA_002_GARDEN_BARREL' },
        { type: 'dialogue', dialogueId: 'DIA_002_GARDEN_CLEAR' },
        { type: 'questAdvance', questId: 'QST_002' },
        { type: 'addItem', itemId: 'heal_grass', quantity: 2 },
        { type: 'addItem', itemId: 'pineapple_seed', quantity: 1 },
        { type: 'setFlag', flag: 'garden_cleaned', value: true },
      ],
    },
    {
